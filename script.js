...
btnRoll.addEventListener('click',function(){
    if( sum_player_total_0<100 && sum_player_total_1<100){
        ...
        diceEl.src=`/photos/dice-${String(dice)}.png`;
...
/////////////////////////////////////////////////////
document.querySelector('.question_mark_button').addEventListener('click',function(){
    let list=document.querySelectorAll('.how_to_play');
    console.log(list)
